...
public class EvenSubArrays {
    ...
    public static void main(String[] args) {
        ...
        ArrayList<Integer> input = Util.fillArrayList(new int[]{796, 483, 671, 998, 149, 374, 801, 191, 457, 802, 903, 329, 191, 286, 153, 600, 917, 189, 724, 741, 306, 253, 520, 372 }); // expected YES
