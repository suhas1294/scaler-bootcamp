...
Input Format : First and only argument is a 2D integer array A denoting the grid of size M x N.
Output Format : Return an integer denoting the knight's minimum initial health so that he is able to rescue the princess.
...
Output 2: 1
Explanation 2: Take the path DOWN -> DOWN ->RIGHT -> RIGHT, the minimum health required will be 1.
 */